        ...
        <>
            ...
            {isOpen && (
                <motion.div
                    ...
                    className="fixed top-4 md:top-16 right-4 md:right-10 z-[9200] bg-primary-bg border border-editorial-black/10 rounded-lg shadow-lg overflow-hidden w-56"
                >
